...
# Agora para implementar um formatador de texto,
# começamos com uma implementação ineficiente.
class FormattedText:
...
# Podemos ter uma implementação mais eficiente
# ao se basear em ranges
